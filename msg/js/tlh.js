...
Blockly.Msg.ROBOT_COLOUR_TITLE = "set colour";  // untranslated
Blockly.Msg.ROBOT_COLOUR_TOOLTIP = "Change the colour of the pen.";  // untranslated
Blockly.Msg.ROBOT_LED_OFF = "LED off";  // untranslated
Blockly.Msg.ROBOT_LED_OFF_TOOLTIP = "Turn the robot's LED light off.";  // untranslated
Blockly.Msg.ROBOT_LED_ON = "LED on";  // untranslated
Blockly.Msg.ROBOT_LED_ON_TOOLTIP = "Turn the robot's LED light on.";  // untranslated
Blockly.Msg.ROBOT_MOVE_BACKWARD = "move backward by";  // untranslated
Blockly.Msg.ROBOT_MOVE_FORWARD = "move forward by";  // untranslated
Blockly.Msg.ROBOT_MOVE_FORWARD_100_TITLE = "move forward by 100";  // untranslated
Blockly.Msg.ROBOT_MOVE_FORWARD_100_TOOLTIP = "Move the robot forward 100 pixels.";  // untranslated
Blockly.Msg.ROBOT_MOVE_TOOLTIP = "Move the robot %1 %2 pixels.";  // untranslated
Blockly.Msg.ROBOT_PEN_DOWN = "pen down";  // untranslated
Blockly.Msg.ROBOT_PEN_TOOLTIP = "Lift or lower the pen, to start or stop drawing.";  // untranslated
Blockly.Msg.ROBOT_PEN_UP = "pen up";  // untranslated
Blockly.Msg.ROBOT_SET_WIDTH = "set width";  // untranslated
Blockly.Msg.ROBOT_TURN_LEFT = "turn left by";  // untranslated
Blockly.Msg.ROBOT_TURN_RIGHT = "turn right by";  // untranslated
Blockly.Msg.ROBOT_TURN_RIGHT_90_TITLE = "turn right by 90";  // untranslated
Blockly.Msg.ROBOT_TURN_RIGHT_90_TOOLTIP = "Turn the robot right by 90 degrees.";  // untranslated
Blockly.Msg.ROBOT_TURN_TOOLTIP = "Turn the robot %1 by %2 degrees.";  // untranslated
Blockly.Msg.ROBOT_VISIBILITY_HIDE = "hide robot";  // untranslated
Blockly.Msg.ROBOT_VISIBILITY_SHOW = "show robot";  // untranslated
Blockly.Msg.ROBOT_VISIBILITY_TOOLTIP_INVISIBLE = "Make the robot invisible.";  // untranslated
Blockly.Msg.ROBOT_VISIBILITY_TOOLTIP_VISIBLE = "Make the robot visible.";  // untranslated
Blockly.Msg.ROBOT_WIDTH_TOOLTIP = "Change the width of the pen.";  // untranslated
Blockly.Msg.TEXT_APPEND_HELPURL = "https://github.com/google/blockly/wiki/Text#text-modification";  // untranslated
Blockly.Msg.TEXT_APPEND_TITLE = "chel";
Blockly.Msg.TEXT_APPEND_TOOLTIP = "ghItlh";
...
Blockly.Msg.TEXT_CHARAT_TITLE = "ghItlhDaq";
...
Blockly.Msg.TEXT_INDEXOF_TITLE = "ghItlhDaq";
