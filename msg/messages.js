...
/// {{Notranslate}} Hue value for all robot blocks.
Blockly.Msg.ROBOT_HUE = '80';
...
//Robot Blocks.
/// block text - Title of the block that moves the robot forward by 100 pixels.
Blockly.Msg.ROBOT_MOVE_FORWARD_100_TITLE = 'move forward by 100';
/// tooltip - Description of the block that moves the robot forward 100 pixels.
Blockly.Msg.ROBOT_MOVE_FORWARD_100_TOOLTIP = 'Move the robot forward 100 pixels.';
/// block text - Title of the block that turns the robot by 90 degrees.
Blockly.Msg.ROBOT_TURN_RIGHT_90_TITLE = 'turn right by 90';
/// tooltip - Description of the block that turns the robot by 90 degrees.
Blockly.Msg.ROBOT_TURN_RIGHT_90_TOOLTIP = 'Turn the robot right by 90 degrees.';
/// dropdown - Indicates that the robot will move forwards.
Blockly.Msg.ROBOT_MOVE_FORWARD = 'move forward by';
/// dropdown - Indicates that the robot will move backwards.
Blockly.Msg.ROBOT_MOVE_BACKWARD = 'move backward by';
/// tooltip - Description of the block that moves the robot %1 by %2 pixels.
Blockly.Msg.ROBOT_MOVE_TOOLTIP = 'Move the robot %1 %2 pixels.';
/// dropdown - Indicates that the robot will turn left.
Blockly.Msg.ROBOT_TURN_LEFT = 'turn left by';
/// dropdown - Indicates that the robot will turn right.
Blockly.Msg.ROBOT_TURN_RIGHT = 'turn right by';
/// tooltip - Description of the block that turns the robot left or right by %2 degrees.
Blockly.Msg.ROBOT_TURN_TOOLTIP = 'Turn the robot %1 by %2 degrees.';
/// block text - Title of the block that changes the width of the pen.
Blockly.Msg.ROBOT_SET_WIDTH = 'set width';
/// tooltip - Description of the block that changes the width of the pen.
Blockly.Msg.ROBOT_WIDTH_TOOLTIP = 'Change the width of the pen.';
/// dropdown - Indicates that the robot will stop drawing.
Blockly.Msg.ROBOT_PEN_UP = 'pen up';
/// dropdown - Indicates that the robot will start drawing.
Blockly.Msg.ROBOT_PEN_DOWN = 'pen down';
/// tooltip - Description of the block that indicates when to start or stop drawing.
Blockly.Msg.ROBOT_PEN_TOOLTIP = 'Lift or lower the pen, to start or stop drawing.';
/// block text - Title of the block that changes the color of the pen.
Blockly.Msg.ROBOT_COLOUR_TITLE = 'set colour';
/// tooltip - Description of the block that changes the color of the pen.
Blockly.Msg.ROBOT_COLOUR_TOOLTIP = 'Change the colour of the pen.';
/// dropdown - Indicates that the robot will become visible.
Blockly.Msg.ROBOT_VISIBILITY_SHOW = 'show robot';
/// dropdown - Indicates that the robot will become invisible.
Blockly.Msg.ROBOT_VISIBILITY_HIDE = 'hide robot';
/// tooltip - Description of the block that makes the robot visible.
Blockly.Msg.ROBOT_VISIBILITY_TOOLTIP_VISIBLE = 'Make the robot visible.';
/// tooltip - Description of the block that makes the robot invisible.
Blockly.Msg.ROBOT_VISIBILITY_TOOLTIP_INVISIBLE = 'Make the robot invisible.';
/// dropdown - Indicates that the robot's led will turn on.
Blockly.Msg.ROBOT_LED_ON = 'LED on';
/// dropdown - Indicates that the robot's led will turn off.
Blockly.Msg.ROBOT_LED_OFF = 'LED off';
/// tooltip - Description of the block that makes the robot visible.
Blockly.Msg.ROBOT_LED_ON_TOOLTIP = 'Turn the robot\'s LED light on.';
/// tooltip - Description of the block that makes the robot invisible.
Blockly.Msg.ROBOT_LED_OFF_TOOLTIP = 'Turn the robot\'s LED light off.';
